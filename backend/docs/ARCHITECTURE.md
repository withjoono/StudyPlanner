...
| 패키지명                   | 경로                    | 설명                 |
| -------------------------- | ----------------------- | -------------------- |
| `@gb-planner/frontend`     | `frontend`         | React 프론트엔드 앱  |
| `@gb-planner/backend`      | `backend`          | NestJS 백엔드 API    |
| `@gb-planner/shared-types` | `shared` | 공유 TypeScript 타입 |
